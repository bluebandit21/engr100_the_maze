...
ds_grid_set_region(map,9,12,12,12,tiletypes.wall);
...
ds_grid_set_region(map,13,2,13,5,tiletypes.wall);
ds_grid_set_region(map,13,7,13,9,tiletypes.wall);
ds_grid_set_region(map,14,2,14,2,tiletypes.wall);

ds_grid_set_region(map,3,1,3,1,tiletypes.lever_red);
ds_grid_set_region(map,1,13,1,13,tiletypes.gate_red);
ds_grid_set_region(map,11,14,11,14,tiletypes.lever_green);
ds_grid_set_region(map,13,6,13,6,tiletypes.gate_green);
